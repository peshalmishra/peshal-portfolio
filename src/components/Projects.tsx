...
const projects = [
    ...
    {
        title: "Quasar – Productivity Workspace",
        description: "A full-stack productivity workspace with JWT auth, project & task management, a TipTap rich-text editor with auto-save and PDF export, animated dashboards, and Docker/Kubernetes deployment support.",
        highlight: "Rich-text editor with PDF export 📄",
        tech: ["React", "Node.js", "MongoDB", "TipTap", "Framer Motion", "Docker"],
        github: "https://github.com/peshalmishra/quasar",
        live: "https://quasar-frontend-eight.vercel.app/",
        stars: 9,
        forks: 2,
        accent: "#818cf8",
        image: "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=800&q=80&auto=format&fit=crop",
        imageAlt: "Productivity workspace with task board and document editor",
    },
    {
        title: "Sage AI – Ecommerce Dashboard",
        description: "An AI-powered ecommerce admin dashboard with full product CRUD, 5 Gemini AI content tools (descriptions, tags, captions, pricing, trends), revenue analytics, low stock alerts, and a Shopify-inspired dark SaaS UI.",
        highlight: "5 AI content tools via Gemini 🤖",
        tech: ["React", "Node.js", "MongoDB", "Gemini AI", "Tailwind", "Chart.js"],
        github: "https://github.com/peshalmishra/sage",
        live: "https://sage-woad.vercel.app/",
        stars: 18,
        forks: 5,
        accent: "#f59e0b",
        image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80&auto=format&fit=crop",
        imageAlt: "AI-powered ecommerce analytics dashboard with dark UI",
    },
    {
